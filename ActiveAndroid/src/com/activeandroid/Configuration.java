...
public class Configuration {
	...
	public static class Builder {
		...
		//add by alex for pwd
		private static final String AA_DB_PWD = "AA_DB_PWD";
		private static final String DEFAULT_DB_PWD = "alex";
		//end
		...
		//add by alex for pwd
		public Builder setDatabasePwd(String databasePwd) {
			mDatabasePwd = databasePwd;
			return this;
		}
		//end
		...
		public Configuration create() {
			...
			//add by alex for pwd
			if (mDatabasePwd != null) {
				configuration.mDatabasePwd = mDatabasePwd;
			} else {
				configuration.mDatabasePwd = getMetaDataPwdOrDefault();
			}
			//end
		...
		// Meta-data methods
		//alex add for encode database pwd
		private String getMetaDataPwdOrDefault() {
			String aaPwd = ReflectionUtils.getMetaData(mContext, AA_DB_PWD);
			if (aaPwd == null) {
				aaPwd = DEFAULT_DB_PWD;
			}
